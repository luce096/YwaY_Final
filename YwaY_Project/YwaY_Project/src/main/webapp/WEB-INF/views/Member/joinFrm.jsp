                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" name="joinfrm" action="memberjoin" onsubmit="return joinform_check()" method="post">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3 mb-2 ">
                                        <input type="button" class="btn btn-primary btn-user btn-block" id="checkId"
                                            value="중복검사" />
                                    </div>
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control form-control-user " id="memberpw"
                                            name="memberpw" placeholder="비밀번호 입력(영문자+숫자+특수문자)">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-9 ">
                                        <input type="text" class="form-control form-control-user" name="email"
                                            id="email" placeholder="이메일입력">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-9 ">
                                        <input type="text" class="form-control form-control-user" name="summonername"
                                            id="summonername" placeholder="소환사이름">
                                    </div>
                                </div>
            ...
            function () {
                if ($('#memberid').val() != '') {
                    $.ajax({
                        type: 'get', //post가능
                        url: 'member/userid',
                        data: 'memberid=' + $('#memberid').val(), //{m_id:$('#id').val(),,,,}
                        dataType: 'json', //'html', //'json', //사용할수 있는 아이디 입니다.
                        success: function (data) {
                            console.log(data);
                            $('#memberid').html(data).css('border',
                                'solid blue 1px');
                            $('#result').html(data).css('color', 'blue');
                        },
                        error: function (err) {
                            console.log(err);
                            $('#result').html(err.responseText).css(
                                'color', 'red');
                            $('#memberid').html(err.responseText).css(
