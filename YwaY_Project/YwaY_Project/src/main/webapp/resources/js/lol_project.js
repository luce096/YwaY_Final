...
//let multisearchnamelist = ['빛준범','작지만큰하늘','z관우','김금민','황플레이어'];
...
$(document).ready(function(){   //도큐먼트 레디
    $.ajax({
        url: "resources/json/credentials.json?version=18",
        type: 'GET',
        dataType: 'json',
        async: false,
        success: function(res){
	        ...
	        key7 = res.riot_api_key7;
	        key8 = res.riot_api_key8;
	        key9 = res.riot_api_key9;
            puuidList[0] = res.dk1;
	        puuidList[1] = res.dk2;
	        puuidList[2] = res.dk3;
	        puuidList[3] = res.dk4;
    ...
    let getLatestDataDragonVersionRequest = $.ajax({    //데이터드래곤 최신버전 유지
        ...
        success: function(res){
            ...
            $.when.apply(null, loadInitialDataRequestCallback).done(function(){   //초기 로드?
                ...
                getSummonerInfo4(puuidList);            	
            });
        },
    });

    const searcherInput = $('#summoner_btn');  //엔터를 누르면 검색됨
    const summonerInPut = $('#summoner_inputt');
    searcherInput.on("click",function(){
    getSummonerInfo("name", summonerInPut.val());
    });
    ...
    multisearchInp.on("click",function(){
	    ...
	    console.log("이거는 어떻게 뜰까요?",multisearchnamelist);
...
for(let i=0;i<20;i++){
    ...
    $.ajax({
        ...
        success: function(res){
            ...
            const summonerName = $('#current_summoner_name_'+i);
			...
			let plus = `
				<form action="">
		    	 <a href="ingame" onclick="findNewSummoner('${res.name}');">${res.name}</a>
		    `
		    summonerName.append(plus);
        },
        error: function(req, stat, err){
            console.log(err);
            if(err == "Not Found") alert("존재하지 않는 소환사");
...
function getSummonerInfo4(puuidList){
for(let i=40;i<50;i++){
    let AfterURL = "https://kr.api.riotgames.com/lol/summoner/v4/summoners/by-puuid/"+puuidList[i];
	console.log("AfterURL",AfterURL);
    $.ajax({
        ...
        data: {
           ...
           success: function(res){
		    ...
		    summonerLevel.text(res.summonerLevel);
		    let plus = `
		    	 <a href="#" onclick="findNewSummoner('${res.name}');">${res.name}</a>
		    `
		    summonerName.append(plus);
        },
        error: function(req, stat, err){
...
(function(i){
        ...
        success: function(res){   
        msMatchid[i]=res;
        //console.log("멀티서치 띄우기위해서 받아온 소환사들의 매치 아이디",msMatchid);
...
(function(i){
 ...
 console.log("멀티서치 띄우기위해서 받아온 소환사들의 매치내용2",muMatchess3);
...
(function(i){
 ...
 console.log("멀티서치 띄우기위해서 받아온 소환사들의 매치내용4",muMatchess4);
...
(function(i){
 ...
 console.log("멀티서치 띄우기위해서 받아온 소환사들의 매치내용5",muMatchess5);
...
function loadSummonerMatchHistory(userInfo, matchId){
    ...
    $.when.apply(null, loadHistoryItemCallback).done(function(){
        for(let i=0;i<10;i++){
			...
			console.log("participantsInfo.length",participantsInfo.length);
			console.log("participantsInfo.length",participantsInfo);
            let champion_img_url = getLatestDataDragonURL()+"/img/champion/"+curChampionInfo.id+".png";
...
console.log("1번검색자의 경기 데이터만 출력",mtsl);
...
//멀티서치 결과를 보여줌
getmultisearchresult4(mtsl5,jun);
...
const multise1 = $('#multi_detail_item');
multise1.remove();


	multisearchj = `
      <tr id="multi_detail_item">
    <th rowspan="2">${mtsl2[0].summonerName}</th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl2[0].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl2[1].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl2[2].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl2[3].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl2[4].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl2[5].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl2[6].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl2[7].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl2[8].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl2[9].championName}.png" alt="Girl in a jacket"></th>
    <th rowspan="2">${jun.winRate}승/${jun.winNum}패<br>${jun.loseNum}%</th>
  </tr>
  <tr id="multi_detail_item">
    
    <td>${mtsl2[0].kills}/${mtsl2[0].deaths}/${mtsl2[0].assists}</td>
    <td>${mtsl2[1].kills}/${mtsl2[1].deaths}/${mtsl2[1].assists}</td>
    <td>${mtsl2[2].kills}/${mtsl2[2].deaths}/${mtsl2[2].assists}</td>
    <td>${mtsl2[3].kills}/${mtsl2[3].deaths}/${mtsl2[3].assists}</td>
    <td>${mtsl2[4].kills}/${mtsl2[4].deaths}/${mtsl2[4].assists}</td>
    <td>${mtsl2[5].kills}/${mtsl2[5].deaths}/${mtsl2[5].assists}</td>
    <td>${mtsl2[6].kills}/${mtsl2[6].deaths}/${mtsl2[6].assists}</td>
    <td>${mtsl2[7].kills}/${mtsl2[7].deaths}/${mtsl2[7].assists}</td>
    <td>${mtsl2[8].kills}/${mtsl2[8].deaths}/${mtsl2[8].assists}</td>
    <td>${mtsl2[9].kills}/${mtsl2[9].deaths}/${mtsl2[9].assists}</td>
   
    
  </tr>
        `;
        multisearchresult.append(multisearchj); 
...
const multisearchresult = $('#multi-detail-info-data');
const multise4 = $('#multi_detail_item');
multise4.remove();


	multisearchj = `
      <tr id="multi_detail_item">
    <th rowspan="2">${mtsl5[0].summonerName}</th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl5[0].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl5[1].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl5[2].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl5[3].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl5[4].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl5[5].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl5[6].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl5[7].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl5[8].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl5[9].championName}.png" alt="Girl in a jacket"></th>
    <th rowspan="2">${jun.winRate}승/${jun.winNum}패<br>${jun.loseNum}%</th>
  </tr>
  <tr id="multi_detail_item">
    
    <td>${mtsl5[0].kills}/${mtsl5[0].deaths}/${mtsl5[0].assists}</td>
    <td>${mtsl5[1].kills}/${mtsl5[1].deaths}/${mtsl5[1].assists}</td>
    <td>${mtsl5[2].kills}/${mtsl5[2].deaths}/${mtsl5[2].assists}</td>
    <td>${mtsl5[3].kills}/${mtsl5[3].deaths}/${mtsl5[3].assists}</td>
    <td>${mtsl5[4].kills}/${mtsl5[4].deaths}/${mtsl5[4].assists}</td>
    <td>${mtsl5[5].kills}/${mtsl5[5].deaths}/${mtsl5[5].assists}</td>
    <td>${mtsl5[6].kills}/${mtsl5[6].deaths}/${mtsl5[6].assists}</td>
    <td>${mtsl5[7].kills}/${mtsl5[7].deaths}/${mtsl5[7].assists}</td>
    <td>${mtsl5[8].kills}/${mtsl5[8].deaths}/${mtsl5[8].assists}</td>
    <td>${mtsl5[9].kills}/${mtsl5[9].deaths}/${mtsl5[9].assists}</td>
...
const multisearchresult = $('#multi-detail-info-data');
const multise2 = $('#multi_detail_item');
multise2.remove();


	multisearchj = `
      <tr id="multi_detail_item">
    <th rowspan="2">${mtsl3[0].summonerName}</th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl3[0].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl3[1].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl3[2].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl3[3].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl3[4].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl3[5].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl3[6].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl3[7].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl3[8].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl3[9].championName}.png" alt="Girl in a jacket"></th>
    <th rowspan="2">${jun.winRate}승/${jun.winNum}패<br>${jun.loseNum}%</th>
  </tr>
  <tr id="multi_detail_item">
    
    <td>${mtsl3[0].kills}/${mtsl3[0].deaths}/${mtsl3[0].assists}</td>
    <td>${mtsl3[1].kills}/${mtsl3[1].deaths}/${mtsl3[1].assists}</td>
    <td>${mtsl3[2].kills}/${mtsl3[2].deaths}/${mtsl3[2].assists}</td>
    <td>${mtsl3[3].kills}/${mtsl3[3].deaths}/${mtsl3[3].assists}</td>
    <td>${mtsl3[4].kills}/${mtsl3[4].deaths}/${mtsl3[4].assists}</td>
    <td>${mtsl3[5].kills}/${mtsl3[5].deaths}/${mtsl3[5].assists}</td>
    <td>${mtsl3[6].kills}/${mtsl3[6].deaths}/${mtsl3[6].assists}</td>
    <td>${mtsl3[7].kills}/${mtsl3[7].deaths}/${mtsl3[7].assists}</td>
    <td>${mtsl3[8].kills}/${mtsl3[8].deaths}/${mtsl3[8].assists}</td>
    <td>${mtsl3[9].kills}/${mtsl3[9].deaths}/${mtsl3[9].assists}</td>
...
const multisearchresult = $('#multi-detail-info-data');
const multise3 = $('#multi_detail_item');
multise3.remove();


	multisearchj = `
      <tr id="multi_detail_item">
    <th rowspan="2">${mtsl4[0].summonerName}</th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl4[0].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl4[1].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl4[2].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl4[3].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl4[4].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl4[5].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl4[6].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl4[7].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl4[8].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl4[9].championName}.png" alt="Girl in a jacket"></th>
    <th rowspan="2">${jun.winRate}승/${jun.winNum}패<br>${jun.loseNum}%</th>
  </tr>
  <tr id="multi_detail_item">
    
    <td>${mtsl4[0].kills}/${mtsl4[0].deaths}/${mtsl4[0].assists}</td>
    <td>${mtsl4[1].kills}/${mtsl4[1].deaths}/${mtsl4[1].assists}</td>
    <td>${mtsl4[2].kills}/${mtsl4[2].deaths}/${mtsl4[2].assists}</td>
    <td>${mtsl4[3].kills}/${mtsl4[3].deaths}/${mtsl4[3].assists}</td>
    <td>${mtsl4[4].kills}/${mtsl4[4].deaths}/${mtsl4[4].assists}</td>
    <td>${mtsl4[5].kills}/${mtsl4[5].deaths}/${mtsl4[5].assists}</td>
    <td>${mtsl4[6].kills}/${mtsl4[6].deaths}/${mtsl4[6].assists}</td>
    <td>${mtsl4[7].kills}/${mtsl4[7].deaths}/${mtsl4[7].assists}</td>
    <td>${mtsl4[8].kills}/${mtsl4[8].deaths}/${mtsl4[8].assists}</td>
    <td>${mtsl4[9].kills}/${mtsl4[9].deaths}/${mtsl4[9].assists}</td>
...
multise2.remove();
	...
	multisearchj = `
      <tr id="multi_detail_item">
    <th rowspan="2">${mtsl[0].summonerName}</th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl[0].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl[1].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl[2].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl[3].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl[4].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl[5].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl[6].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl[7].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl[8].championName}.png" alt="Girl in a jacket"></th>
    <th><img src="http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${mtsl[9].championName}.png" alt="Girl in a jacket"></th>
    <th rowspan="2">${jun.winRate}승/${jun.winNum}패<br>${jun.loseNum}%</th>
  </tr>
  <tr id="multi_detail_item">
    
    <td>${mtsl[0].kills}/${mtsl[0].deaths}/${mtsl[0].assists}</td>
    <td>${mtsl[1].kills}/${mtsl[1].deaths}/${mtsl[1].assists}</td>
    <td>${mtsl[2].kills}/${mtsl[2].deaths}/${mtsl[2].assists}</td>
    <td>${mtsl[3].kills}/${mtsl[3].deaths}/${mtsl[3].assists}</td>
    <td>${mtsl[4].kills}/${mtsl[4].deaths}/${mtsl[4].assists}</td>
    <td>${mtsl[5].kills}/${mtsl[5].deaths}/${mtsl[5].assists}</td>
    <td>${mtsl[6].kills}/${mtsl[6].deaths}/${mtsl[6].assists}</td>
    <td>${mtsl[7].kills}/${mtsl[7].deaths}/${mtsl[7].assists}</td>
    <td>${mtsl[8].kills}/${mtsl[8].deaths}/${mtsl[8].assists}</td>
    <td>${mtsl[9].kills}/${mtsl[9].deaths}/${mtsl[9].assists}</td>
